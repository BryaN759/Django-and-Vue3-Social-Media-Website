<template>
    ...
    <nav class="py-10 px-8 border-b border-gray-200 bg-gray-600">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
                <div class="menu-left">
                    <a href="#" class="text-2xl text-gray-300 text-bold"><strong>Shakkhat</strong></a>
                </div>
    ...
    <main class="flex-grow px-8 py-6 bg-gray-800">
        <RouterView />
    </main>
    </div>
    <Toast />
