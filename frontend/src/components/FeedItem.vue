    ...
    <div class="my-6 flex justify-between">
        <div class="flex space-x-6">
            <div class="flex items-center space-x-2" @click="likePost(post.id)">
                ...
                <span class="text-gray-300 text-xs">{{ post.likes_count }} likes</span>
            </div> 
            ...
            <div class="flex items-center space-x-2">
                ...
                <RouterLink :to="{name: 'postview', params: {id: post.id}}" class="text-gray-300 text-xs">{{ post.comments_count }} comments</RouterLink>
            </div>
        </div>
